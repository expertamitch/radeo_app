...
Future showRemoveUsersBottomSheet(List<Users> users) {
                                      ...
                                      child: Row(children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              "${e.groupUsersCount} Members",
                                              style:
                                                  w300_10(color: Colors.grey),
                                            ),
                                          ],
                                        ),
                                        Expanded(
                ...
                AppButton(
                    onPressedFunction: () async {
                      cloneUsers.forEach((element) {
                        element.users!.removeWhere((data) => data.selected);
                      });

                      //new added groups
                      cloneGroups.removeWhere((element) => element.selected);
                      inviteController.tempGroupsList.forEach((element) {
                        element.selected = false;
                        cloneGroups.forEach((cg) {
                          if (cg.id == element.id) {
