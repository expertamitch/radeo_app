...
class RecordVoiceMessagePage extends StatefulWidget {
  const RecordVoiceMessagePage({Key? key}) : super(key: key);

  @override
  State<RecordVoiceMessagePage> createState() => _RecordVoiceMessagePageState();
}
...
*/
  ...
  Icon recorderAssetImage() {
    ...
    return (recorderModule.isStopped) ? Icon(Icons.mic) : Icon(Icons.stop);
  }
            ...
            Container(
              ...
              child: ClipOval(
                child: TextButton(
                  ...
                  //disabledColor: Colors.white,
                  //padding: EdgeInsets.all(8.0),
                  child: (onPauseResumePlayerPressed() != null)
                      ? Icon(Icons.pause_circle_filled)
                      : Icon(Icons.pause_circle_outline),
                ),
              ),
